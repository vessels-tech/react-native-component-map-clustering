...
class MapView extends PureComponent {
  ...
  _calculateClusters = () => {
    if (this.hasSuperClusterLoaded && this.superCluster && this.state.region) {
      ...
      console.log("_calculateClusters, zoom is:", zoom);
      //TODO: if zoom is 9, stop clustering
  ...
  render() {
    ...
    return (
      <RNMapView
        ...
        {clustering && !shouldShowAll ? this.state.clusters : children}
        {clustering && !shouldShowAll && this.state.others}
      </RNMapView>
    );
  }
}
